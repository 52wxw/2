...
public class AdminController {
    ...
    @Autowired
    public AdminController(UserService userService, TaskService taskService, SubmissionService submissionService,UserRepository userRepository, TaskRepository taskRepository) {
