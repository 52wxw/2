    ...
    <header class="bg-sub-bg border-b border-gray-800 sticky top-0 z-50 transition-all duration-300" :class="{ 'shadow-lg': scrolled }">
      <div class="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center space-x-6">
          <router-link to="/tasks" class="text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-list-ul mr-1"></i> {{ $t('navigation.tasks') }}
          </router-link>
          <router-link to="/ranking" class="text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-trophy mr-1"></i> {{ $t('navigation.ranking') }}
          </router-link>
          <!-- 移除团队和挑战 -->
          <!-- 添加控制台链接 -->
          <a href="https://console.example.com" target="_blank" class="text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-terminal mr-1"></i> {{ $t('navigation.console') }}
          </a>
        </nav>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative">
            ...
            >
              ...
              />
              <span class="hidden md:inline-block font-medium text-lg">{{ user.username || 'Guest' }}</span> <!-- 增大字体 -->
      ...
      >
        <div class="container mx-auto px-4 py-3 flex flex-col space-y-3">
          <router-link to="/tasks" class="py-2 text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-list-ul mr-1"></i> {{ $t('navigation.tasks') }}
          </router-link>
          <router-link to="/ranking" class="py-2 text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-trophy mr-1"></i> {{ $t('navigation.ranking') }}
          </router-link>
          <!-- 移除团队和挑战 -->
          <!-- 添加控制台链接 -->
          <a href="http://openstack/dashboard" target="_blank" class="py-2 text-gray-400 hover:text-white transition-colors text-lg"> <!-- 增大字体 -->
            <i class="fa-solid fa-terminal mr-1"></i> {{ $t('navigation.console') }}
          </a>
        </div>
      </div>
